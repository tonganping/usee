...
<?php if($_SESSION['admin_role'] == 1) {?>
    ...
    <div class="issue_div">
        <a href="/index.php/admin/edit" class="btn" id="btn_edit">添加</a>
    </div>
    <table class="data_list" width="100%" cellspacing="0" cellpadding="0">
        ...
        <?php if(is_array($data_list)): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <a href="/index.php/admin/changepwd/id/<?php echo ($data["id"]); ?>">重置密码</a>
                <a href="javascript:;" onclick="Deleter('Admin', <?php echo ($data["id"]); ?>);">删除</a>
            </td>
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    </table>
<?php } else {?>   

<?php if(is_array($data_list)): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><a href="/index.php/admin/changepwd/id/<?php echo ($data["id"]); ?>" class="btn" >重置密码</a><?php endforeach; endif; else: echo "" ;endif; ?>
