...
<div class="admin_left">
    ...
    <ul class="submenu">
        <li><a href="/index.php/User/changepwd/"><b class="ico0"></b><span>角色管理</span></a></li>
...
<div class="admin_right">
    ...
    <form id="editForm" action="/index.php/User/changeSave">
        <table cellspacing="0" cellpadding="0" class="issue_tab">
            <tr>
                <td width="80">旧密码</td>
                <td class="issue_td">
                    <input class="name" type="text" name="name" value="<?php echo ($data["name"]); ?>" />
                </td>
            </tr>
            <tr>
                <td>新密码</td>
                <td class="issue_td">
                    <input class="name" type="text" name="baby_name" value="<?php echo ($data["baby_name"]); ?>" />
                </td>
            </tr>
            ...
            <tr>
                <td ></td>
                <td>
                    <a href="/index.php/User/index" class="fr btn">返回</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
