...
<div class="admin_right">
    ...
    <div class="data_list_bt">摄像头及图片资源管理</div>

    <div class="issue_div">
        <a href="/index.php/Camera/edit" class="btn" id="btn_edit">添加</a>
    </div>
    ...
    <table class="data_list" width="100%">
        ...
        <?php if(is_array($data_list)): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <a href="/index.php/Camera/edit/id/<?php echo ($data["id"]); ?>">编辑</a>
                <a href="javascript:;" onclick="Deleter('Camera', <?php echo ($data["id"]); ?>);">删除</a>
            </td>
